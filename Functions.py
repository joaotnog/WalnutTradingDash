...
def get_cryptocompare_data(syms, all_data, days, currency="USD"):

  # Build base request:
  syms = ",".join(syms)
  base_url = "https://min-api.cryptocompare.com/data/histoday?"
  base_params = f"fsym={syms}&tsym={currency}&aggregate=1"
  req_url = base_url + base_params

  # Set timeframe:
  if all_data:
    req_url += "&allData=true"
  else:
    req_url += f"&limit={days - 1}"

  # Make request:
  return requests.get(req_url).json()

def prep_cryptocompare_data(raw_json):
  df = pd.DataFrame.from_dict(raw_json["Data"])
  df["timestamp"] = [datetime.fromtimestamp(d).date() for d in df.time]
  df = df.drop(["time", "conversionType", "conversionSymbol"], axis=1)
  df.columns = ['High','Low','Open','Volume','Volume_','Close','Date']
  df = df[['High','Low','Open','Volume','Close','Date']]
...
def implement_supertrend(num_stream, data, start_date, end_date):
    ...
    entry_condition_inputs = num_stream.sidebar; entry_condition_inputs.header('With the strategy')
    
    # 1. ST ENTRY DATA 1
    
    entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'st_entry_input1')
    
    if entry_input_1 == 'SuperTrend':
        period, multiplier = entry_condition_inputs.columns(2)
        period = int(period.slider('x days indicator', value = 7, key = 'st_entry_period1'))
        multiplier=3 #multiplier = int(multiplier.text_input('SuperTrend Multiplier', value = 3, key = 'st_entry_multiplier1'))
    ...
    entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'st_entry_comparator')
    
    # 3. ST ENTRY DATA 2
    
    entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'st_entry_input2')
    
    if entry_input_2 == 'SuperTrend':
        period, multiplier = entry_condition_inputs.columns(2)
        period = int(period.slider('x days indicator', value = 7, key = 'st_entry_period2'))
        multiplier=3 #multiplier = int(multiplier.text_input('SuperTrend Multiplier', value = 3, key = 'st_entry_multiplier2'))
    ...
    exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'st_exit_input1')
    
    if exit_input_1 == 'SuperTrend':
        period, multiplier = exit_condition_inputs.columns(2)
        period = int(period.slider('x days indicator', value = 7, key = 'st_exit_period1'))
        multiplier=3 #multiplier = int(multiplier.text_input('SuperTrend Multiplier', value = 3, key = 'st_exit_multiplier1'))
    ...
    exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'st_exit_comparator')
    
    # 3. ST EXIT DATA 2
    
    exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'st_exit_input2')
    
    if exit_input_2 == 'SuperTrend':
        period, multiplier = exit_condition_inputs.columns(2)
        period = int(period.slider('x days indicator', value = 7, key = 'st_exit_period2'))
        multiplier=3 #multiplier = int(multiplier.text_input('SuperTrend Multiplier', value = 3, key = 'st_exit_multiplier2'))
        ...
        exit_data2 = entry_condition_inputs.number_input('', min_value = 0, value = 0, key = 'number2')
    else:
...
def implement_negative_directional_index(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = '-di_entry_input1')

        if entry_input_1 == '-DI, Negative Directional Index':
            period, offset = entry_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 14, key = '-di_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = '-di_entry_comparator')

        # 3. -DI ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = '-di_entry_input2')

        if entry_input_2 == '+DI, Positive Directional Index':
            period, offset = entry_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 14, key = '+di_entry_period2'))
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = '-di_exit_input1')

        if exit_input_1 == '-DI, Negative Directional Index':
            period, offset = exit_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 14, key = '-di_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = '-di_exit_comparator')

        # 3. -DI EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = '-di_exit_input2')

        if exit_input_2 == '+DI, Positive Directional Index':
            period, offset = exit_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 14, key = '+di_exit_period2'))
...
def implement_normalized_average_true_range(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'natr_entry_input1')

        if entry_input_1 == 'Normalized Average True Range (NATR)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 14, key = 'natr_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'natr_entry_comparator')

        # 3. NATR ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'natr_entry_input2')

        if entry_input_2 == 'Normalized Average True Range (NATR)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 25, key = 'natr_entry_period2'))
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'natr_exit_input1')

        if exit_input_1 == 'Normalized Average True Range (NATR)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 14, key = 'natr_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'natr_exit_comparator')

        # 3. NATR EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'natr_exit_input2')

        if exit_input_2 == 'Normalized Average True Range (NATR)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 25, key = 'natr_exit_period2'))
...
def implement_average_directional_index(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'adx_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'adx_entry_comparator')

        # 3. ADX ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'adx_entry_input2')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'adx_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'adx_exit_comparator')

        # 3. ADX EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'adx_exit_input2')
...
def implement_stochastic_oscillator_fast(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'sof_entry_input1')

        if entry_input_1 == 'Stochastic Oscillator Fast (SOF)':
            period, offset = entry_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 14, key = 'sof_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'sof_entry_comparator')

        # 3. SOF ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'sof_entry_input2')

        if entry_input_2 == 'Number':
            entry_data2 = entry_condition_inputs.number_input('', min_value = 0, value = 30, key = 'number1')
        else:
            pass
       ...
       ######### SOF EXIT CONDITION #########
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'sof_exit_input1')

        if exit_input_1 == 'Stochastic Oscillator Fast (SOF)':
            period, offset = exit_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 14, key = 'sof_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'sof_exit_comparator')

        # 3. SOF EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'sof_exit_input2')

        if exit_input_2 == 'Number':
            exit_data2 = exit_condition_inputs.number_input('', min_value = 0, value = 80, key = 'number2')
        else:
            pass
...
def implement_stochastic_oscillator_slow(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'sos_entry_input1')

        if entry_input_1 == 'Stochastic Oscillator Slow (SOS)':
            period, offset = entry_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 3, key = 'sos_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'sos_entry_comparator')

        # 3. SOS ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'sos_entry_input2')
       ...
       ######### SOS EXIT CONDITION #########
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'sos_exit_input1')

        if exit_input_1 == 'Stochastic Oscillator Slow (SOS)':
            period, offset = exit_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 3, key = 'sos_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'sos_exit_comparator')

        # 3. SOS EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'sos_exit_input2')
...
def implement_weighted_moving_average(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'wma_entry_input1')

        if entry_input_1 == 'Weighted Moving Average (WMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 60, key = 'wma_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'wma_entry_comparator')

        # 3. WMA ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'wma_entry_input2')

        if entry_input_2 == 'Weighted Moving Average (WMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'wma_entry_period2'))
        ...
        if entry_input_2 == 'Exponential Moving Average (EMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'ema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
        ...
        if entry_input_2 == 'Simple Moving Average (SMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'sma_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
        ...
        if entry_input_2 == 'Triangular Moving Average (TRIMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'trima_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
        ...
        if entry_input_2 == 'Triple Exponential Moving Average (TEMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'tema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
        ...
        if entry_input_2 == 'Double Exponential Moving Average (DEMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'dema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'wma_exit_input1')

        if exit_input_1 == 'Weighted Moving Average (WMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 60, key = 'wma_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'wma_exit_comparator')

        # 3. WMA EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'wma_exit_input2')

        if exit_input_2 == 'Weighted Moving Average (WMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'wma_exit_period2'))
        ...
        if exit_input_2 == 'Exponential Moving Average (EMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'ema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
        ...
        if exit_input_2 == 'Simple Moving Average (SMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'sma_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
        ...
        if exit_input_2 == 'Triangular Moving Average (TRIMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'trima_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
        ...
        if exit_input_2 == 'Triple Exponential Moving Average (TEMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'tema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
        ...
        if exit_input_2 == 'Double Exponential Moving Average (DEMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'dema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
...
def implement_momentum_indicator(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'mom_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'mom_entry_comparator')

        # 3. MOM ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'mom_entry_input2')
        ...
        if entry_input_2 == 'Momentum Indicator (MOM)':
            ...
            entry_data2 = entry_condition_inputs.number_input('', min_value = 0, value = 0, key = 'mom_number1')
        else:
            pass
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'mom_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'mom_exit_comparator')

        # 3. MOM EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'mom_exit_input2')
        ...
        if exit_input_2 == 'Momentum Indicator (MOM)':
            ...
            exit_data2 = exit_condition_inputs.number_input('', min_value = 0, value = 0, key = 'mom_number2')
        else:
            pass
...
def implement_vortex_indicator(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'vi_entry_input1')

        if entry_input_1 == 'Vortex Indicator (VI)':
            period, offset = entry_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 14, key = '+vi_entry_period1'))
            ...
            period, offset = entry_condition_inputs.columns(2) 
            period=14 #period = int(period.text_input('-VI Period', value = 14, key = '-vi_entry_period1'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = '-vi_entry_offset1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'vi_entry_comparator')

        # 3. VI ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'vi_entry_input2')

        if entry_input_2 == '-VI':
            period, offset = entry_condition_inputs.columns(2) 
            period=14 #period = int(period.text_input('-VI Period', value = 14, key = '-vi_entry_period2'))
            ...
            period, offset = entry_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 14, key = '+vi_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = '+vi_entry_offset2'))
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'vi_exit_input1')

        if exit_input_1 == 'Vortex Indicator (VI)':
            period, offset = exit_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 14, key = '+vi_exit_period1'))
            ...
            period, offset = exit_condition_inputs.columns(2) 
            period=14 #period = int(period.text_input('-VI Period', value = 14, key = '-vi_exit_period1'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = '-vi_exit_offset1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'vi_exit_comparator')

        # 3. VI EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'vi_exit_input2')

        if exit_input_2 == '-VI':
            period, offset = exit_condition_inputs.columns(2) 
            period=14 #period = int(period.text_input('-VI Period', value = 14, key = '-vi_exit_period2'))
            ...
            period, offset = exit_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 14, key = '+vi_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = '+vi_exit_offset2'))
...
def implement_chande_momentum_oscillator(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'cmo_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'cmo_entry_comparator')

        # 3. CMO ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'cmo_entry_input2')
        ...
        if entry_input_2 == 'Chande Momentum Oscillator (CMO)':
            ...
            entry_data2 = entry_condition_inputs.number_input('', min_value = 0, value = 0, key = 'cmo_number1')
        else:
            pass
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'cmo_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'cmo_exit_comparator')

        # 3. CMO EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'cmo_exit_input2')
        ...
        if exit_input_2 == 'Chande Momentum Oscillator (CMO)':
            ...
            exit_data2 = exit_condition_inputs.number_input('', min_value = 0, value = 0, key = 'cmo_number2')
        else:
            pass
...
def implement_exponential_moving_average(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'ema_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'ema_entry_comparator')

        # 3. EMA ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'ema_entry_input2')
        ...
        if entry_input_2 == 'Exponential Moving Average (EMA)':
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 50, key = 'wma_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.wma(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 50, key = 'sma_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.sma(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 50, key = 'trima_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.trima(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 50, key = 'tema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.tema(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 50, key = 'dema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.dema(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'ema_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'ema_exit_comparator')

        # 3. EMA EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'ema_exit_input2')
        ...
        if exit_input_2 == 'Exponential Moving Average (EMA)':
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 50, key = 'wma_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.wma(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 50, key = 'sma_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.sma(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 50, key = 'trima_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.trima(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 50, key = 'tema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.tema(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 50, key = 'dema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.dema(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
...
def implement_triple_exponential_moving_average(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'tema_entry_input1')

        if entry_input_1 == 'Triple Exponential Moving Average (TEMA)':
            period, offset = entry_condition_inputs.columns(2)
            period=20 #period = int(period.text_input('tema Period', value = 20, key = 'tema_entry_period1'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset0'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'tema_entry_comparator')

        # 3. TEMA ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'tema_entry_input2')

        if entry_input_2 == 'Triple Exponential Moving Average (TEMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'tema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.tema(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'wma_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.wma(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'sma_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.sma(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'trima_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.trima(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'ema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.ema(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'dema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.dema(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'tema_exit_input1')

        if exit_input_1 == 'Triple Exponential Moving Average (TEMA)':
            period, offset = exit_condition_inputs.columns(2)
            period=20 #period = int(period.text_input('tema Period', value = 20, key = 'tema_exit_period1'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'exit_offset'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'tema_exit_comparator')

        # 3. TEMA EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'tema_exit_input2')

        if exit_input_2 == 'Triple Exponential Moving Average (TEMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'tema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.tema(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'wma_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.wma(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'sma_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.sma(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'trima_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.trima(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'ema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.ema(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'dema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.dema(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
...
def implement_double_exponential_moving_average(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'dema_entry_input1')

        if entry_input_1 == 'Double Exponential Moving Average (DEMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 9, key = 'dema_entry_period1'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset0'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'dema_entry_comparator')

        # 3. DEMA ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'dema_entry_input2')

        if entry_input_2 == 'Double Exponential Moving Average (DEMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'dema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.dema(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'wma_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.wma(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'sma_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.sma(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'trima_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.trima(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'ema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.ema(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'tema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.tema(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'dema_exit_input1')

        if exit_input_1 == 'Double Exponential Moving Average (DEMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 9, key = 'dema_exit_period1'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'exit_offset'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'dema_exit_comparator')

        # 3. DEMA EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'dema_exit_input2')

        if exit_input_2 == 'Double Exponential Moving Average (DEMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'dema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.dema(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'wma_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.wma(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'sma_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.sma(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'trima_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.trima(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'tema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.tema(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
...
def implement_simple_moving_average(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'sma_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'sma_entry_comparator')

        # 3. SMA ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'sma_entry_input2')
        ...
        if entry_input_2 == 'Simple Moving Average (SMA)':
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 26, key = 'wma_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.wma(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 26, key = 'trima_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.trima(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 26, key = 'tema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.tema(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
            ...
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 26, key = 'dema_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset1'))
            entry_data2 = ta.dema(data.Close, length = period, offset = offset)
            entry_data2.index = entry_data2.index.astype(str)
            entry_data2 = entry_data2[entry_data2.index >= str(start_date)]
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'sma_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'sma_exit_comparator')

        # 3. SMA EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'sma_exit_input2')
        ...
        if exit_input_2 == 'Simple Moving Average (SMA)':
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 26, key = 'wma_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.wma(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 26, key = 'trima_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.trima(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 26, key = 'tema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.tema(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
            ...
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 26, key = 'dema_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset2'))
            exit_data2 = ta.dema(data.Close, length = period, offset = offset)
            exit_data2.index = exit_data2.index.astype(str)
            exit_data2 = exit_data2[exit_data2.index >= str(start_date)]
...
def implement_triangular_moving_average(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'trima_entry_input1')

        if entry_input_1 == 'Triangular Moving Average (TRIMA)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'trima_entry_period1'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'offset0'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'trima_entry_comparator')

        # 3. TRIMA ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'trima_entry_input2')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'trima_exit_input1')

        if exit_input_1 == 'Triangular Moving Average (TRIMA)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 20, key = 'trima_exit_period1'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'exit_offset'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'trima_exit_comparator')

        # 3. TRIMA EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'trima_exit_input2')
...
def implement_chande_forecast_oscillator(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'cfo_entry_input1')

        if entry_input_1 == 'Chande Forecast Oscillator (CFO)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 14, key = 'cfo_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'cfo_entry_comparator')

        # 3. CFO ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'cfo_entry_input2')
        
        if entry_input_2 == 'Number':
            entry_data2 = entry_condition_inputs.number_input('', min_value = 0, value = 0, key = 'number1')
        elif entry_input_2 == 'Chande Forecast Oscillator (CFO)':
            period, offset = entry_condition_inputs.columns(2)
            period=25 #period = int(period.text_input('cfo Period', value = 25, key = 'cfo_entry_period2'))
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'cfo_exit_input1')

        if exit_input_1 == 'Chande Forecast Oscillator (CFO)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 14, key = 'cfo_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'cfo_exit_comparator')

        # 3. CFO EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'cfo_exit_input2')

        if exit_input_2 == 'Number':
            exit_data2 = exit_condition_inputs.number_input('', min_value = 0, value = 0, key = 'number2')
        elif exit_input_2 == 'Chande Forecast Oscillator (CFO)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 25, key = 'cfo_exit_period2'))
...
def implement_choppiness_index(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'ci_entry_input1')

        if entry_input_1 == 'Choppiness Index':
            period, offset = entry_condition_inputs.columns(2)
            period=14 #period = int(period.text_input('CI Period', value = 14, key = 'ci_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'ci_entry_comparator')

        # 3. CHOP ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'ci_entry_input2')
        
        if entry_input_2 == 'Number':
            entry_data2 = entry_condition_inputs.number_input('', min_value = 0, value = 40, key = 'number1')
        elif entry_input_2 == 'Choppiness Index':
            period, offset = entry_condition_inputs.columns(2)
            period=50 #period = int(period.text_input('ci Period', value = 50, key = 'ci_entry_period2'))
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'ci_exit_input1')

        if exit_input_1 == 'Choppiness Index':
            period, offset = exit_condition_inputs.columns(2)
            period=14 #period = int(period.text_input('CI Period', value = 14, key = 'ci_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'ci_exit_comparator')

        # 3. CHOP EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'ci_exit_input2')

        if exit_input_2 == 'Number':
            exit_data2 = exit_condition_inputs.number_input('', min_value = 0, value = 60, key = 'number2')
        elif exit_input_2 == 'Choppiness Index':
            period, offset = exit_condition_inputs.columns(2)
            period=50 #period = int(period.text_input('CI Period', value = 50, key = 'ci_exit_period2'))
...
def implement_aroon_down(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'aroond_entry_input1')

        if entry_input_1 == 'Aroon Down':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'aroond_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'aroond_entry_comparator')

        # 3. AROOND ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'aroond_entry_input2')
        
        if entry_input_2 == 'Number':
            entry_data2 = entry_condition_inputs.number_input('', min_value = 0, value = 0, key = 'number1')
        elif entry_input_2 == 'Aroon Up':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'aroond_entry_period2'))
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'aroond_exit_input1')

        if exit_input_1 == 'Aroon Down':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'aroond_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'aroond_exit_comparator')

        # 3. AROOND EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'aroond_exit_input2')

        if exit_input_2 == 'Number':
            exit_data2 = exit_condition_inputs.number_input('', min_value = 0, value = 0, key = 'number2')
        elif exit_input_2 == 'Aroon Up':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'aroond_exit_period2'))
...
def implement_average_true_range(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'atr_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'atr_entry_comparator')

        # 3. ATR ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'atr_entry_input2')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'atr_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'atr_exit_comparator')

        # 3. ATR EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'atr_exit_input2')
...
def implement_williamsr(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'wr_entry_input1')

        if entry_input_1 == 'Williams %R':
            period, offset = entry_condition_inputs.columns(2)
            period=14 #period = int(period.text_input('W%R Period', value = 14, key = 'wr_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'wr_entry_comparator')

        # 3. WR ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'wr_entry_input2')

        if entry_input_2 == 'Number':
            entry_data2 = entry_condition_inputs.number_input('', value = -80, min_value = -100, 
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'wr_exit_input1')

        if exit_input_1 == 'Williams %R':
            period, offset = exit_condition_inputs.columns(2)
            period=14 #period = int(period.text_input('W%R Period', value = 14, key = 'wr_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'wr_exit_comparator')

        # 3. WR EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'wr_exit_input2')

        if exit_input_2 == 'Number':
            exit_data2 = exit_condition_inputs.number_input('', min_value = -100, value = -20, 
...
def implement_parabolic_sar(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'psar_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'psar_entry_comparator')

        # 3. PSAR ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'psar_entry_input2')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'psar_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'psar_exit_comparator')

        # 3. PSAR EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'psar_exit_input2')
...
def implement_coppock_curve(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'coppock_curve_entry_input1')
        ...
        if entry_input_1 == 'Coppock Curve':
            ...
            slow=14 #slow = int(offset.text_input('Long ROC', value = 14, key = 'coppock_curve_entry_slow1'))
            period = int(period.slider('x days indicator', value = 10, key = 'coppock_curve_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'coppock_curve_entry_comparator')
        ...
        if entry_input_2 == 'Coppock Curve':
            ...
            fast = int(period.text_input('Short ROC', value = 11, key = 'coppock_curve_entry_fast1'))
            slow=14 #slow = int(offset.text_input('Long ROC', value = 14, key = 'coppock_curve_entry_slow1'))
            period = int(period.slider('x days indicator', value = 21, key = 'coppock_curve_entry_period1'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = 'coppock_curve_entry_offset1'))
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'coppock_curve_exit_input1')
        ...
        if exit_input_1 == 'Coppock Curve':
            ...
            slow=14 #slow = int(offset.text_input('Long ROC', value = 14, key = 'coppock_curve_exit_slow1'))
            period = int(period.slider('x days indicator', value = 10, key = 'coppock_curve_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'coppock_curve_exit_comparator')
        ...
        if exit_input_2 == 'Coppock Curve':
            ...
            fast = int(period.text_input('Short ROC', value = 11, key = 'coppock_curve_exit_fast1'))
            slow=14 #slow = int(offset.text_input('Long ROC', value = 14, key = 'coppock_curve_exit_slow1'))
            period = int(period.slider('x days indicator', value = 21, key = 'coppock_curve_exit_period2'))
...
def implement_positive_directional_index(num_stream, data, start_date, end_date):
        ...
        if entry_input_2 == '+DI, Positive Directional Index':
            period, offset = entry_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 21, key = '+di_entry_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = '+di_entry_offset2'))
        ...
        if exit_input_2 == '+DI, Positive Directional Index':
            period, offset = exit_condition_inputs.columns(2) 
            period = int(period.slider('x days indicator', value = 21, key = '+di_exit_period2'))
            offset=0 #offset = int(offset.text_input('Offset (Optional)', value = 0, key = '+di_exit_offset2'))
            ...
            exit_data2 = exit_condition_inputs.number_input('', min_value = 0, value = 0, key = 'number1')
        else:
            pass
...
def implement_rsi(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'rsi_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'rsi_entry_comparator')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'rsi_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'rsi_exit_comparator')
...
def implement_macd_signal(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'macdsignal_entry_input1')
        ...
        if entry_input_1 == 'MACD Signal':
            ...
            fast_ma=12 #fast_ma = int(fast_ma.text_input('Fast MA', value = 12, key = 'macdsignal_entry_fast1'))
            slow_ma=26 #slow_ma = int(slow_ma.text_input('Slow MA', value = 26, key = 'macdsignal_entry_slow1'))
            signal_period=9 #signal_period = int(signal_period.text_input('Signal Period', value = 9, key = 'macdsignal_entry_signal1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'macdsignal_entry_comparator')
        
        # 3. MACD SIGNAL ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'macdsignal_entry_input2')

        if entry_input_2 == 'MACD':
            fast_ma, slow_ma = entry_condition_inputs.columns(2)
            signal_period, offset = entry_condition_inputs.columns(2)
            fast_ma=12 #fast_ma = int(fast_ma.text_input('Fast MA', value = 12, key = 'macdsignal_entry_fast2'))
            slow_ma=26 #slow_ma = int(slow_ma.text_input('Slow MA', value = 26, key = 'macdsignal_entry_slow2'))
            signal_period=9 #signal_period = int(signal_period.text_input('Signal Period', value = 9, key = 'macdsignal_entry_signal2'))
            ...
            entry_data2 = entry_condition_inputs.number_input('', value = 0, min_value = 0, key = 'number1')
        else:
            pass
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'macdsignal_exit_input1')
        ...
        if exit_input_1 == 'MACD Signal':
            ...
            fast_ma=12 #fast_ma = int(fast_ma.text_input('Fast MA', value = 12, key = 'macdsignal_exit_fast1'))
            slow_ma=26 #slow_ma = int(slow_ma.text_input('Slow MA', value = 26, key = 'macdsignal_exit_slow1'))
            signal_period=9 #signal_period = int(signal_period.text_input('Signal Period', value = 9, key = 'macdsignal_exit_signal1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'macdsignal_exit_comparator')
        
        # 3. MACD SIGNAL EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'macdsignal_exit_input2')

        if exit_input_2 == 'MACD':
            fast_ma, slow_ma = exit_condition_inputs.columns(2)
            signal_period, offset = exit_condition_inputs.columns(2)
            fast_ma=12 #fast_ma = int(fast_ma.text_input('Fast MA', value = 12, key = 'macdsignal_exit_fast2'))
            slow_ma=26 #slow_ma = int(slow_ma.text_input('Slow MA', value = 26, key = 'macdsignal_exit_slow2'))
            signal_period=9 #signal_period = int(signal_period.text_input('Signal Period', value = 9, key = 'macdsignal_exit_signal2'))
            ...
            exit_data2 = exit_condition_inputs.number_input('', value = 0, min_value = 0, key = 'number2')
        else:
            pass
...
def implement_aroon_oscillator(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'aroonosc_entry_input1')

        if entry_input_1 == 'Aroon Oscillator':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'aroonosc_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'aroonosc_entry_comparator')

        # 3. AROON OSC ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'aroonosc_entry_input2')
        
        if entry_input_2 == 'Number':
            entry_data2 = entry_condition_inputs.number_input('', min_value = 0, value = 0, key = 'number1')
        elif entry_input_2 == 'Aroon Up':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'aroonosc_entry_period2'))
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'aroonosc_exit_input1')

        if exit_input_1 == 'Aroon Oscillator':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'aroonosc_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'aroonosc_exit_comparator')

        # 3. AROON OSC EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'aroonosc_exit_input2')
        
        if exit_input_2 == 'Number':
            exit_data2 = exit_condition_inputs.number_input('', min_value = 0, value = 0, key = 'number2')
        elif exit_input_2 == 'Aroon Up':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 40, key = 'aroonosc_exit_period2'))
...
def implement_stochrsi_fastk(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'stochrsifk_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'stochrsifk_entry_comparator')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'stochrsifk_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'stochrsifk_exit_comparator')
...
def implement_stochrsi_fastd(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'stochrsifd_entry_input1')

        if entry_input_1 == 'Stochastic RSI FastD':
            rsi_period, d_period = entry_condition_inputs.columns(2)
            matype, offset = entry_condition_inputs.columns(2)
            rsi_period = int(rsi_period.slider('x days indicator', value = 14, key = 'stochrsifd_entry_rp1'))
            d_period=3 #d_period = int(d_period.text_input('D Period', value = 3, key = 'stochrsifd_entry_dp1'))
            matype='sma' #matype = matype.selectbox('MA Type', mas, key = 'stochrsifd_entry_matype1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'stochrsifd_entry_comparator')
        
        # 3. STOCH RSI FASTD ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'stochrsifd_entry_input2')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'stochrsifd_exit_input1')

        if exit_input_1 == 'Stochastic RSI FastD':
            rsi_period, d_period = exit_condition_inputs.columns(2)
            matype, offset = exit_condition_inputs.columns(2)
            rsi_period = int(rsi_period.slider('x days indicator', value = 14, key = 'stochrsifd_exit_rp1'))
            d_period=3 #d_period = int(d_period.text_input('D Period', value = 3, key = 'stochrsifd_exit_dp1'))
            matype='sma' #matype = matype.selectbox('MA Type', mas, key = 'stochrsifd_exit_matype1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'stochrsifd_exit_comparator')
        
        # 3. STOCH RSI FASTD EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'stochrsifd_exit_input2')
...
def implement_ultimate_oscillator(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'uo_entry_input1')
        ...
        if entry_input_1 == 'Ultimate Oscillator':
            ...
            slow=28 #slow = int(slow.text_input('Slow', value = 28, key = 'uo_entry_fast1'))
            fast=7 #fast = int(fast.text_input('Fast', value = 7, key = 'uo_entry_slow1'))
            medium=14 #medium = int(medium.text_input('Medium', value = 14, key = 'uo_entry_signal1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'uo_entry_comparator')
        
        # 3. UO ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'uo_entry_input2')

        if entry_input_2 == 'Number':
            entry_data2 = entry_condition_inputs.number_input('', value = 50, min_value = 0, 
                                                              max_value = 100, key = 'number1')
        else:
            pass
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'uo_exit_input1')
        ...
        if exit_input_1 == 'Ultimate Oscillator':
            ...
            slow=28 #slow = int(slow.text_input('Slow', value = 28, key = 'uo_exit_fast1'))
            fast=7 #fast = int(fast.text_input('Fast', value = 7, key = 'uo_exit_slow1'))
            medium=14 #medium = int(medium.text_input('Medium', value = 14, key = 'uo_exit_signal1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'uo_exit_comparator')
        
        # 3. UO EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'uo_exit_input2')

        if exit_input_2 == 'Number':
            exit_data2 = exit_condition_inputs.number_input('', value = 50, min_value = 0, 
                                                              max_value = 100, key = 'number1')
        else:
            pass
...
def implement_aroon_up(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'aroonu_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'aroonu_entry_comparator')

        # 3. AROONU ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'aroonu_entry_input2')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'aroonu_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'aroonu_exit_comparator')

        # 3. AROONU EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'aroonu_exit_input2')
...
def implement_bollinger_bands(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'bbands_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'bbands_entry_comparator')
        
        # 3. BB ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'bbands_entry_input2')

        if entry_input_2 == 'Lower BB':
            period, std = entry_condition_inputs.columns(2)
            matype, offset = entry_condition_inputs.columns(2)
            period=20 #period = int(period.text_input('Period', value = 20, key = 'bbands_entry_p1'))
            std=2 #std = int(std.text_input('Standard Deviation', value = 2, key = 'bbands_entry_std1'))
            matype='sma' #matype = matype.selectbox('MA Type', mas, key = 'bbands_entry_matype1')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'bbands_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'bbands_exit_comparator')
        
        # 3. BB EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'bbands_exit_input2')

        if exit_input_2 == 'Lower BB':
            period, std = exit_condition_inputs.columns(2)
            matype, offset = exit_condition_inputs.columns(2)
            period=20 #period = int(period.text_input('Period', value = 20, key = 'bbands_exit_p1'))
            std=2 #std = int(std.text_input('Standard Deviation', value = 2, key = 'bbands_exit_std1'))
            matype='sma' #matype = matype.selectbox('MA Type', mas, key = 'bbands_exit_matype1')
...
def implement_trix(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'trix_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'trix_entry_comparator')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'trix_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'trix_exit_comparator')
...
def implement_cci(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'cci_entry_input1')

        if entry_input_1 == 'Commodity Channel Index (CCI)':
            period, offset = entry_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'cci_entry_period1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'cci_entry_comparator')

        # 3. CCI ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'cci_entry_input2')

        if entry_input_2 == 'Number':
            entry_data2 = entry_condition_inputs.number_input('', value = -100, key = 'number1')
        else:
            pass
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'cci_exit_input1')

        if exit_input_1 == 'Commodity Channel Index (CCI)':
            period, offset = exit_condition_inputs.columns(2)
            period = int(period.slider('x days indicator', value = 21, key = 'cci_exit_period1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'cci_exit_comparator')

        # 3. CCI EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'cci_exit_input2')

        if exit_input_2 == 'Number':
            exit_data2 = exit_condition_inputs.number_input('', value = 100, key = 'number2')
        else:
            pass
...
def implement_macd(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'macdl_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'macdl_entry_comparator')
        
        # 3. MACD ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'macdl_entry_input2')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'macdl_exit_input1')

        if exit_input_1 == 'MACD':
            fast_ma, slow_ma = exit_condition_inputs.columns(2)
            signal_period, offset = exit_condition_inputs.columns(2)
            fast_ma=12 #fast_ma = int(fast_ma.text_input('Fast MA', value = 12, key = 'macdl_exit_fast1'))
            slow_ma=26 #slow_ma = int(slow_ma.text_input('Slow MA', value = 26, key = 'macdl_exit_slow1'))
            signal_period=9 #signal_period = int(signal_period.text_input('Signal Period', value = 9, key = 'macdl_exit_signal1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'macdl_exit_comparator')
        
        # 3. MACD EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'macdl_exit_input2')
...
def implement_macd_histogram(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'macdhist_entry_input1')

        if entry_input_1 == 'MACD Histogram':
            fast_ma, slow_ma = entry_condition_inputs.columns(2)
            signal_period, offset = entry_condition_inputs.columns(2)
            fast_ma=12 #fast_ma = int(fast_ma.text_input('Fast MA', value = 12, key = 'macdhist_entry_fast1'))
            slow_ma=26 #slow_ma = int(slow_ma.text_input('Slow MA', value = 26, key = 'macdhist_entry_slow1'))
            signal_period=9 #signal_period = int(signal_period.text_input('Signal Period', value = 9, key = 'macdhist_entry_signal1'))
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'macdhist_entry_comparator')
        
        # 3. MACD HISTOGRAM ENTRY DATA 2

        entry_input_2 = inputs2[0] #entry_input_2 = entry_condition_inputs.selectbox('INDICATOR', inputs2, key = 'macdhist_entry_input2')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'macdhist_exit_input1')

        if exit_input_1 == 'MACD Histogram':
            fast_ma, slow_ma = exit_condition_inputs.columns(2)
            signal_period, offset = exit_condition_inputs.columns(2)
            fast_ma=12 #fast_ma = int(fast_ma.text_input('Fast MA', value = 12, key = 'macdhist_exit_fast1'))
            slow_ma=26 #slow_ma = int(slow_ma.text_input('Slow MA', value = 26, key = 'macdhist_exit_slow1'))
            signal_period=9 #signal_period = int(signal_period.text_input('Signal Period', value = 9, key = 'macdhist_exit_signal1'))
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'macdhist_exit_comparator')
        
        # 3. MACD HISTOGRAM EXIT DATA 2

        exit_input_2 = inputs2[0] #exit_input_2 = exit_condition_inputs.selectbox('INDICATOR', inputs2, key = 'macdhist_exit_input2')
...
def implement_mfi(num_stream, data, start_date, end_date):
        ...
        entry_condition_inputs.text('BUY when the '); entry_input_1 = inputs1[0] #entry_input_1 = entry_condition_inputs.selectbox('BUY WHEN', inputs1, key = 'mfi_entry_input1')
        ...
        entry_comparator = entry_condition_inputs.selectbox('', entry_conditions, key = 'mfi_entry_comparator')
        ...
        exit_condition_inputs.text('and SELL when the '); exit_input_1 = inputs1[0] #exit_input_1 = exit_condition_inputs.selectbox('AND SELL WHEN', inputs1, key = 'mfi_exit_input1')
        ...
        exit_comparator = exit_condition_inputs.selectbox('', exit_conditions, key = 'mfi_exit_comparator')
