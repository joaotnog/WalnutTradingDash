...
if (cf_bt == True) and \
    ...
    if max(strategy_signals)==0:
        st.info('no buy signals during the trading interval, try different parameters')
    else:    
        def get_plot(n):
        ...
        signals = [entry_data1, entry_data2, exit_data1, exit_data2]
